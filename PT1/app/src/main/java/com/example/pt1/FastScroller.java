...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            mVerticalThumbHeight = Math.max(defaultWidth * 5, Math.min(verticalVisibleLength,
        ...
        if (mNeedHorizontalScrollbar) {
            ...
            mHorizontalThumbWidth = Math.max(defaultWidth * 5, Math.min(horizontalVisibleLength,
    ...
    private void verticalScrollTo(float y) {
        ...
        int scrollingBy = scrollTo(mVerticalDragY, y, scrollbarRange, mRecyclerView.computeVerticalScrollRange(),
    ...
    private void horizontalScrollTo(float x) {
        ...
        int scrollingBy = scrollTo(mHorizontalDragX, x, scrollbarRange,
                mRecyclerView.computeHorizontalScrollRange(), mRecyclerView.computeHorizontalScrollOffset(),
                mRecyclerViewWidth);
        if (scrollingBy != 0) {
    ...
    boolean isPointInsideVerticalThumb(float x, float y) {
        return (isLayoutRTL() ? x <= mVerticalThumbWidth / 2 : x >= mRecyclerViewWidth - mVerticalThumbWidth)
